...
class MechanicCustomHorizontalList extends StatefulWidget {
  MechanicCustomHorizontalList({super.key});
  ...
  @override
  _MechanicCustomHorizontalListState createState() =>
      _MechanicCustomHorizontalListState();
}

class _MechanicCustomHorizontalListState
    extends State<MechanicCustomHorizontalList> {
  @override
            ...
            itemBuilder: (context, index) {
              return Row(
                children: [
                  GestureDetector(
                    onTap: () {
                      // Navigate to MechanicListScreen on tap
                      Navigator.push(
                        context,
                        MaterialPageRoute(
